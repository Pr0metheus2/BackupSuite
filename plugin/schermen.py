skinstartfullhd = """
	<screen name="BackupSuite" position="fill" size="1920,1080" title=" " >
		...
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/f_text.png" alphatest="on" position="1100,1030" size="54,38" />
		...
		<widget name="key_text" 	position="1150,1030" size="380,36"  valign="top" halign="left" zPosition="4"  foregroundColor="#00A4A4A4" font="Regular;34" />
...
skinstarthd = """
	<screen name="BackupSuite" position="fill" size="1280,720" title=" " >
		...
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/key_text.png" alphatest="on" position="710,641" size="35,25" />
		...
		<widget name="key_text" 	position="750,643" size="220,28"  valign="top" halign="left" zPosition="4"  foregroundColor="#00A4A4A4" font="Regular;22" />
...
skinstartsd = """
	<screen name="BackupSuite" position="fill" size="720,576" title=" " >
		...
		<ePixmap pixmap="skin_default/buttons/key_text.png" zPosition="1" position="390,516" size="35,25" alphatest="blend"/>
		...
		<widget source="key_text" render="Label" position="410,514" zPosition="1" size="150,45" font="Regular;20" foregroundColor="#00A4A4A4" halign="left" valign="top" />
...
skinflashfullhd = """
	<screen name="FlashImageConfig" position="center,center" size="1920,1080" title=" " >
		...
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/f_green.png"	position="622,1030" size="38,38" alphatest="on" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/f_yellow.png" position="1057,1030" size="38,38" alphatest="on" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/f_text.png" position="1100,1030" size="38,38" alphatest="on" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/f_blue.png" position="1492,1030" size="38,38" alphatest="on" />
		...
		<widget source="key_text"	render="Label" 	position="1120,1030" size="380,36"  valign="top" halign="left" zPosition="4"  foregroundColor="#00A4A4A4" font="Regular;34" />
...
skinflashhd = """
	<screen name="FlashImageConfig" position="center,center" size="1280,720" title=" " >
		...
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/green.png" position="420,641" size="30,30" alphatest="on" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/yellow.png" position="695,641" size="30,30" alphatest="on" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/key_text.png" position="710,641" size="30,30" alphatest="on" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/BackupSuite/img/blue.png" position="970,641" size="30,30" alphatest="on" />
		...
		<widget source="key_text"	render="Label" position="750,643" size="220,28" valign="top" halign="left" zPosition="4" foregroundColor="#00A4A4A4" font="Regular;22"  />
...
skinflashsd = """
	<screen name="FlashImageConfig" position="fill" size="720,576" title=" " >
		...
		<ePixmap pixmap="skin_default/buttons/button_green.png" zPosition="1" position="190,516" size="15,16" alphatest="blend"/>
		<ePixmap pixmap="skin_default/buttons/button_yellow.png" zPosition="1" position="370,516" size="15,16" alphatest="blend"/>
		<ePixmap pixmap="skin_default/buttons/key_text.png" zPosition="1" position="390,516" size="15,16" alphatest="blend"/>
		<ePixmap pixmap="skin_default/buttons/button_blue.png" zPosition="1" position="550,516" size="15,16" alphatest="blend"/>
		<widget source="key_red" render="Label" position="30,514" zPosition="1" size="150,45" font="Regular;20" foregroundColor="#00ff0000" halign="left" valign="top" />
		<widget source="key_green" render="Label" position="210,514" zPosition="1" size="150,45" font="Regular;20" foregroundColor="#0053b611" halign="left" valign="top" />
		<widget source="key_yellow" render="Label" position="390,514" zPosition="1" size="150,45" font="Regular;20" foregroundColor="#00F9C731" halign="left" valign="top" />
